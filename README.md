...
1. **Installing APK on your device:** You can get debug [APK](https://github.com/dhanrajdadhich78/susi_android/blob/apk/susi-debug.apk) as well as Release [APK](https://github.com/dhanrajdadhich78/susi_android/blob/apk/susi-release.apk) in apk branch of the repository. After each PR merge, both the APKs are automatically updated. So, just download the APK you want and install it on your device. The APKs will always be the latest one.
...
This project is currently licensed under the Apache License Version 2.0. A copy of [LICENSE.md](https://github.com/dhanrajdadhich78/susi_android/blob/master/LICENSE) should be present along with the source code. To obtain the software under a different license, please contact FOSSASIA.
